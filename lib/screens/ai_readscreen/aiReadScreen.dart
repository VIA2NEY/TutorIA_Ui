...
import 'package:tutoria/screens/chat_screen.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          ...
          style: TextStyle(fontSize: 14, color: Color(0xFF27354B)),
        ),
        foregroundColor: const Color(0xFF27354B),
        centerTitle: true,
        ...
        children: [
          Padding(
            ...
            child: Container(
              height: 90.h,
              width: 90.w,
              decoration: const BoxDecoration(color: Color(0xFF27354B)),
              child: Padding(
                        ...
                        child: IconButton(
                          onPressed: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    const ChatScreen(), // Remplacez ProchainePage par votre prochaine page
                              ),
                            );
                          },
                          icon: const Icon(
